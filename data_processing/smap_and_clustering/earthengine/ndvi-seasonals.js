...
function seasonForYear(year, season) {
  ...
  return imageCollection.filterDate(start, end).mean();
}
...
var DJF = seasonalClimatology('DJF', startYear, endYear);

...
HIST_DATA_DIR   = Path(__file__).parent.parent.parent / 'data' / 'temperature' / 'hist_GCM' / 'csv'
FUTURE_DATA_DIR = Path(__file__).parent.parent.parent / 'data' / 'temperature' / 'future_GCM' / 'csv'
OUTPUT_DIR = Path(__file__).parent.parent.parent / 'data' / 'temperature' / 'change_factors'

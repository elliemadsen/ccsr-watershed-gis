...
# Configuration
CHANGE_FACTORS_DIR = Path(__file__).parent.parent.parent / 'data' / 'temperature' / 'change_factors'
GRIDMET_DIR = Path(__file__).parent.parent.parent / 'data' / 'temperature' / 'obs_GRIDMET' / 'processed' / 'seasonal'
OUTPUT_DIR = Path(__file__).parent.parent.parent / 'data' / 'temperature' / 'proj'

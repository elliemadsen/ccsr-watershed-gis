...
# Script lives at data_processing/temperature/0_process_gridmet/
REPO_ROOT = Path(__file__).parent.parent.parent.parent


def download_gridmet_data(year, variable, output_dir=None, watershed_path=None):
    if output_dir is None:
        output_dir = str(REPO_ROOT / 'data' / 'temperature' / 'obs_GRIDMET' / 'raw')
    if watershed_path is None:
        watershed_path = str(REPO_ROOT / 'data' / 'sub-basins' / 'Subbasins.shp')
    """
...
def main():
    ...
    raw_data_dir = REPO_ROOT / 'data' / 'temperature' / 'obs_GRIDMET' / 'raw'
    seasonal_dir = REPO_ROOT / 'data' / 'temperature' / 'obs_GRIDMET' / 'processed' / 'seasonal'
    monthly_dir = REPO_ROOT / 'data' / 'temperature' / 'obs_GRIDMET' / 'processed' / 'monthly'
    watershed_path = str(REPO_ROOT / 'data' / 'sub-basins' / 'Subbasins.shp')

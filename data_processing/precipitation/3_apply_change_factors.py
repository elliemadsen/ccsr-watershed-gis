...
precipitation rasters (2006-2020 @ 30m) to create future climate projections
(2035-2064 @ 30m).
...
3. Multiply the interpolated change factors by the present GRIDMET baseline rasters (2006-2020)
...
Formula: precip_future_30m (2035-2064) = precip_baseline_30m (2006-2020) × CF_precip
...
# Configuration
CHANGE_FACTORS_DIR = Path(__file__).parent.parent.parent / 'data' / 'precipitation' / 'change_factors'
GRIDMET_DIR = Path(__file__).parent.parent.parent / 'data' / 'precipitation' / 'obs_GRIDMET' / 'processed' / 'seasonal'
OUTPUT_DIR = Path(__file__).parent.parent.parent / 'data' / 'precipitation' / 'proj'
...
def load_gridmet_baseline(season):
    ...
    """
    file_path = GRIDMET_DIR / f'precip_final_30m_{BASELINE_PERIOD}_{season}.tif'

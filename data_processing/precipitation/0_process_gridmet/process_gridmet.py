...
# Script lives at data_processing/precipitation/0_process_gridmet/
REPO_ROOT = Path(__file__).parent.parent.parent.parent


def download_gridmet_data(year, output_dir=None):
    if output_dir is None:
        output_dir = str(REPO_ROOT / 'data' / 'precipitation' / 'obs_GRIDMET' / 'raw')
    """
...
def main():
    ...
    raw_data_dir = REPO_ROOT / 'data' / 'precipitation' / 'obs_GRIDMET' / 'raw'
    output_dir = REPO_ROOT / 'data' / 'precipitation' / 'obs_GRIDMET' / 'processed'

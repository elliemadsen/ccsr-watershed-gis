...
HIST_DATA_DIR   = Path(__file__).parent.parent.parent / 'data' / 'precipitation' / 'hist_GCM' / 'csv'
FUTURE_DATA_DIR = Path(__file__).parent.parent.parent / 'data' / 'precipitation' / 'future_GCM' / 'csv'
OUTPUT_DIR = Path(__file__).parent.parent.parent / 'data' / 'precipitation' / 'change_factors'
...
def load_seasonal_means(model_name, period):
    ...
    """
    # Both historical and future come from split directories
    data_dir = HIST_DATA_DIR if period == 'historical' else FUTURE_DATA_DIR
